...
import {Dimensions, Linking, Pressable, StyleSheet, Text, TextInput, View} from 'react-native';
import axios from "axios";
import proj4 from '../assets/proj4'

export function getPolygons (r) {
...
export function humanReadableCoordinates(r) {
...
export default function SinglePlot() {
